...
echo sprintf(__('Are you sure that you want to set the read access level for all attachments of publications on the bookmarklist to "%s"? There is no undo!'), $accesslevel."<p>\n";
