...
echo sprintf(__('Are you sure that you want to set the edit access level for all publications on the bookmarklist to "%s"? There is no undo!'), $editaccesslevel."<p>\n";
