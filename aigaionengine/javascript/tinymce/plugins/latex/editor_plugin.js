		...
		init : function(ed, url) {
			...
			ed.addCommand('mceLatex', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 320 + parseInt(ed.getLang('latex.delta_width', 0)),
					height : 120 + parseInt(ed.getLang('latex.delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('latex', n.nodeName.toLowerCase () == 'code' && n.getAttribute('title'));
			});
		},
