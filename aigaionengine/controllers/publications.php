...
class Publications extends Controller {
  ...
  */
  function keyword()
  {
    echo "This function is not used anymore, please report to the aigaion team and copy this exact message:<br/>";
    echo "controllers/publications/keyword() to be removed.";
  /*
